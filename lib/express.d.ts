...
declare module EX {
    interface IRoute {
        ...
        all(fn?: (req: Request, res: Response, next: Function) => any): Route;

        get(...handlers: RequestFunction[]): Route;

        post(...handlers: RequestFunction[]): Route;

        put(...handlers: RequestFunction[]): Route;

        delete(...handlers: RequestFunction[]): Route;

        patch(...handlers: RequestFunction[]): Route;
    }
    ...
    export interface Application extends IRouter<Application> {
         ...
         */
        listen(port: number, hostname: string, backlog: number, callback?: Function): NodeJS.Http.Server;

        listen(port: number, hostname: string, callback?: Function): NodeJS.Http.Server;

        listen(port: number, callback?: Function): NodeJS.Http.Server;

        listen(path: string, callback?: Function): NodeJS.Http.Server;

        listen(handle: any, listeningListener?: Function): NodeJS.Http.Server;
